...
```sh
pip install https://github.com/hkbinbin/ida-headless-mcp/releases/latest/download/ida_pro_mcp-2.1.3-py3-none-any.whl
```
...
```sh
pip install ida_pro_mcp-2.1.3-py3-none-any.whl
```
